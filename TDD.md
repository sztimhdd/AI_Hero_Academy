...
| `content/reading_content_structured.json` | `{course_id: {concept_text_structured, good_example_structured, anti_pattern_structured, takeaway_structured}}` | 21 entries; generated by `scripts/enrich_reading_content.py`; optional (app falls back to flat text if absent) |
