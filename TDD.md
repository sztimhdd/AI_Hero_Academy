...
| Model | Use case |
|-------|----------|
| `gemini-2.0-flash` | **Default** — scoring, gap maps, coach responses, evaluation, streaming |
| `gemini-3.1-pro` | **Content generation pipeline only** — 7-agent offline content creation with Tavily/Google Search |
